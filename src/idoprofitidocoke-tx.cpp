...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("IDOPROFITIDOCOKE Core idoprofitidocoke-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  idoprofitidocoke-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded idoprofitidocoke transaction") + "\n" +
              "  idoprofitidocoke-tx [options] -create [commands]   " + _("Create hex-encoded idoprofitidocoke transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded idoprofitidocoke transaction

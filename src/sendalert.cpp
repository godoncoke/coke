...
2. run idoprofitidocoked with -printalert or -sendalert like this:
   /path/to/idoprofitidocoked -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.idoprofitidocoke.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/IDOPROFITIDOCOKE Core:0.12.0.58/"));

    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("IDOPROFITIDOCOKE Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a IDOPROFITIDOCOKE address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and idoprofitidocoke: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About IDOPROFITIDOCOKE Core"), this);
    aboutAction->setStatusTip(tr("Show information about IDOPROFITIDOCOKE Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for IDOPROFITIDOCOKE Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your IDOPROFITIDOCOKE addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified IDOPROFITIDOCOKE addresses"));
    ...
    openAction->setStatusTip(tr("Open a idoprofitidocoke: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the IDOPROFITIDOCOKE Core help message to get a list with possible IDOPROFITIDOCOKE Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("IDOPROFITIDOCOKE Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to IDOPROFITIDOCOKE network", "", count));
    } else {
...
{
    QString strTitle = tr("IDOPROFITIDOCOKE Core"); // default title
    ...
    // Append title to "IDOPROFITIDOCOKE Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;

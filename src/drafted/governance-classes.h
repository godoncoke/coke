 ...
 *
 *   // network
 *   CIDOPROFITIDOCOKENetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.idoprofitidocoke.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CIDOPROFITIDOCOKENetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CIDOPROFITIDOCOKENetwork(UniValue objIn)
    {
...
// // can be under: IDOPROFITIDOCOKENetwork
// //   -- signature requirements : Key1(User)
// class CIDOPROFITIDOCOKENetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == IDOPROFITIDOCOKENetwork);
//     // }

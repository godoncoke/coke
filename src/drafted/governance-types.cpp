...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "IDOPROFITIDOCOKENetwork") type = IDOPROFITIDOCOKENetwork;
    if(strType == "IDOPROFITIDOCOKENetworkVariable") type = IDOPROFITIDOCOKENetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == IDOPROFITIDOCOKENetwork) s = "IDOPROFITIDOCOKENetwork";
    if(type == IDOPROFITIDOCOKENetworkVariable) s = "IDOPROFITIDOCOKENetworkVariable";

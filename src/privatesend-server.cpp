...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all IDOPROFITIDOCOKE related functionality
...
/*
    ...
    allow endless transaction that would bloat IDOPROFITIDOCOKE and make it unusable. To
...
void ThreadCheckPrivateSendServer(CConnman& connman)
{
    ...
    RenameThread("idoprofitidocoke-ps-server");

...
Only requiring some minor changes is idoprofitidocoke.cpp.
...
Changes to idoprofitidocoke.cpp
----------------------
idoprofitidocoke.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for

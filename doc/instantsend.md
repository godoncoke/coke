...
This mechanism has been integrated into Bitcore-Node-IDOPROFITIDOCOKE which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/idoprofitidocokepay/insight-api-idoprofitidocoke#web-socket-api](https://github.com/idoprofitidocokepay/insight-api-idoprofitidocoke#web-socket-api)
* API: [https://github.com/idoprofitidocokepay/insight-api-idoprofitidocoke#instantsend-transactions](https://github.com/idoprofitidocokepay/insight-api-idoprofitidocoke#instantsend-transactions)
...
By default, the IDOPROFITIDOCOKE Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the IDOPROFITIDOCOKE Core daemon:
